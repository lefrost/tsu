...
| be/elysia | [Elysia](https://github.com/elysiajs/elysia) | [Bun](https://github.com/oven-sh/bun) | WIP | Bun | Bun package management and websocket; [Kafkajs](https://github.com/tulios/kafkajs) Kafka client. |
