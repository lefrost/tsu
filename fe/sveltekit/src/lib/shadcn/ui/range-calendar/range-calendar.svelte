<script lang="ts">
	...
	import type { ButtonVariant } from "$lib/shadcn/ui/button/index.js";
...
<RangeCalendarPrimitive.Root
	...
	class={cn(
		"p-3 [--cell-radius:var(--radius-md)] [--cell-size:--spacing(6)] group/calendar bg-background p-3 [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
		className
	)}
	{locale}
	{monthFormat}
